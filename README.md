...
| Plan | Topics | Approx hours | Timeline @ 30h/wk |
|------|--------|------|----------|
| 🏢 **FAANG+** | ~145 | ~700h | ~23 weeks |
| 🚀 **Startup** | ~116 | — | practical / full-stack focus |
| **All Topics** | 210 | ~960h | ~32 weeks (full library) |
...
### 2. Set your weekly rhythm (4h/day · ≈30h/week — realistic alongside a job)
- **~12h DSA** — patterns, then the weekly coding mock
- **~9h System Design** — foundations → real systems → deep-dives
- **~3h LLD / OOD** — patterns + machine coding
- **~6h Behavioral + Mocks** — story bank + the weekly recorded mock
